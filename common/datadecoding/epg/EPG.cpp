...
const EPG::gl EPG::genre_list[] =
	...
	{ "3.2.9.9", "Tug-of-war" },
	{ "3.3", "ScrollDown" },
	{ "3.3.1", "Do-it-yourself" },
	{ "3.3.10", "Art" },
	{ "3.3.11", "Music" },
	{ "3.3.12", "Board Games" },
	{ "3.3.13", "Computer Games" },
	{ "3.3.14", "Card Cames" },
	...
	{ "3.4.8", "Erotica" },
	{ "3.4.9", "Drama based on real events (docudrama)" },
	{ "3.5", "SavePage" },
	{ "3.5.1", "Game show" },
	...
	{ "3.5.7.6", "Humour" },
	{ "3.5.9", "Humour" },
	{ "3.50", "Commercial/Products" },
	{ "3.50.1", "Agriculture, forestry and fishery products" },
	{ "3.50.1.1", "Products of agriculture, horticulture and market gardening" },
	{ "3.50.1.2", "Live animals and animal products" },
	{ "3.50.1.3", "Forestry and logging products" },
	{ "3.50.1.4", "Fish and other fishing products" },
	{ "3.50.10", "Community, social and personal services" },
	{ "3.50.10.1", "Public administration and other services to the community as a whole; compulsory social security services" },
	{ "3.50.10.2", "Education services" },
	{ "3.50.10.3", "Health and social services" },
	{ "3.50.10.4", "Sewage and refuse disposal, sanitation and other environmental protection services" },
	{ "3.50.10.5", "Services of membership organizations" },
	{ "3.50.10.6", "Recreational, cultural and sporting services" },
	{ "3.50.10.7", "Other services" },
	{ "3.50.10.8", "Domestic services" },
	{ "3.50.10.9", "Services provided by extraterritorial organizations and bodies" },
	{ "3.50.2", "Ores and minerals; electricity, gas and water" },
	{ "3.50.2.1", "Coal and lignite; peat" },
	{ "3.50.2.2", "Crude petroleum and natural gas" },
	{ "3.50.2.3", "Uranium and thorium ores" },
	{ "3.50.2.4", "Metal ores" },
	{ "3.50.2.5", "Stone, sand and clay" },
	{ "3.50.2.6", "Other minerals" },
	{ "3.50.2.7", "Electricity, town gas, steam and hot water" },
	{ "3.50.2.8", "Water" },
	{ "3.50.3", "Food products, beverages and tobacco; textiles, apparel and leather products" },
	{ "3.50.3.1", "Meat, fish, fruit, vegetables, oils and fats" },
	{ "3.50.3.2", "Dairy products" },
	{ "3.50.3.3", "Grain mill products, starches and starch products; other food products" },
	{ "3.50.3.4", "Beverages" },
	{ "3.50.3.5", "Tobacco products" },
	{ "3.50.3.6", "Yarn and thread; woven and tufted textile fabrics" },
	{ "3.50.3.7", "Textile articles other than apparel" },
	{ "3.50.3.8", "Knitted or crocheted fabrics; wearing apparel" },
	{ "3.50.3.9", "Leather and leather products; footwear" },
	{ "3.50.4", "Other transportable goods, except metal products, machinery and equipment" },
	{ "3.50.4.1", "Products of wood, cork, straw and plaiting materials" },
	{ "3.50.4.2", "Pulp, paper and paper products; printed matter and related articles" },
	{ "3.50.4.3", "Coke oven products; refined petroleum products; nuclear fuel" },
	{ "3.50.4.4", "Basic chemicals" },
	{ "3.50.4.5", "Other chemical products; man-made fibres" },
	{ "3.50.4.6", "Rubber and plastics products" },
	{ "3.50.4.7", "Glass and glass products and other non-metallic products n.e.c." },
	{ "3.50.4.8", "Furniture; other transportable goods n.e.c." },
	{ "3.50.4.9", "Wastes or scraps" },
	{ "3.50.5", "Metal products, machinery and equipment" },
	{ "3.50.5.1", "Basic metals" },
	{ "3.50.5.2", "Fabricated metal products, except machinery and equipment" },
	{ "3.50.5.3", "General purpose machinery" },
	{ "3.50.5.4", "Special purpose machinery" },
	{ "3.50.5.5", "Office, accounting and computing machinery" },
	{ "3.50.5.6", "Electrical machinery and apparatus" },
	{ "3.50.5.7", "Radio, television and communication equipment and apparatus" },
	{ "3.50.5.8", "Medical appliances, precision and optical instruments, watches and clocks" },
	{ "3.50.5.9", "Transport equipment" },
	{ "3.50.6", "Intangible assets; land; constructions; construction services" },
	{ "3.50.6.1", "Intangible assets" },
	{ "3.50.6.2", "Land" },
	{ "3.50.6.3", "Constructions" },
	{ "3.50.6.4", "Construction services" },
	{ "3.50.7", "Distributive trade services; lodging; food and beverage serving services; transport services; and utilities distribution services" },
	{ "3.50.7.1", "Wholesale trade services" },
	{ "3.50.7.2", "Retail trade services" },
	{ "3.50.7.3", "Lodging; food and beverage serving services" },
	{ "3.50.7.4", "Land transport services" },
	{ "3.50.7.5", "Water transport services" },
	{ "3.50.7.6", "Air transport services" },
	{ "3.50.7.7", "Supporting and auxiliary transport services" },
	{ "3.50.7.8", "Postal and courier services" },
	{ "3.50.7.9", "Electricity distribution services; gas and water distribution services through mains" },
	{ "3.50.8", "Financial and related services; real estate services; and rental and leasing services" },
	{ "3.50.8.1", "Financial intermediation, insurance and auxiliary services" },
	{ "3.50.8.2", "Real estate services" },
	{ "3.50.8.3", "Leasing or rental services without operator" },
	{ "3.50.9", "Business and production services" },
	{ "3.50.9.1", "Research and development services" },
	{ "3.50.9.2", "Professional, scientific and technical services" },
	{ "3.50.9.3", "Other professional, scientific and technical services" },
	{ "3.50.9.4", "Telecommunications services; information retrieval and supply services" },
	{ "3.50.9.5", "Support services" },
	{ "3.50.9.6", "Production services, on a fee or contract basis" },
	{ "3.50.9.7", "Maintenance and repair services" },
	{ "3.6", "PrintPage" },
	...
	{ "3.6.2.5", "Traditional/Smooth" },
	{ "3.6.2.6", "Cool" },
	{ "3.6.2.7", "Modern/Avant-garde/Free" },
	...
	{ "3.6.4", "Pop-rock" },
	{ "3.6.4.1", "Pop" },
	{ "3.6.4.10", "Progressive/Alternative/Indie/Experimental/Art-rock" },
	...
	{ "3.6.4.4", "Soft/Slow rock" },
	{ "3.6.4.5", "Classic/Dance/Pop-rock" },
	{ "3.6.4.6", "Folk" },
	{ "3.6.4.7", "Punk/Funk rock" },
	{ "3.6.4.8", "New Age" },
	{ "3.6.4.9", "Instrumental/Band/Symphonic rock/Jam bands" },
	...
	{ "3.6.8.10", "Metal/Death metal/Pop metal" },
	...
	{ "6.0.1", "No content that requires alerting in any of the categories below" },
	{ "6.1", "SEX" },
	...
	{ "6.1.4.1", "One scene of explicit sexual behaviour suitable for adults only" },
	{ "6.1.4.2", "Occasional scenes of explicit sexual behaviour suitable for adults only" },
	{ "6.1.4.3", "Frequent scenes of explicit sexual behaviour suitable for adults only" },
	...
	{ "6.10", "STROBING" },
	{ "6.10.1", "No strobing" },
	{ "6.10.2", "Strobing that could impact on those suffering from Photosensitive epilepsy" },
	{ "6.10.2.1", "One scene of strobing that could impact on those suffering from photosensitive epilepsy" },
	{ "6.10.2.2", "Occasional strobing that could impact on those suffering from photosensitive epilepsy" },
	{ "6.10.2.3", "Frequent strobing that could impact on those suffering from photosensitive epilepsy" },
	{ "6.2", "NUDITY" },
	...
	{ "6.3.3", "Infliction of strong psychological or physical pain to human beings" },
	{ "6.3.3.1", "One scene of infliction of strong psychological or physical pain to human beings" },
	{ "6.3.3.2", "Occasional scenes of infliction of strong psychological or physical pain to human beings" },
	{ "6.3.3.3", "Frequent scenes of infliction of strong psychological or physical pain to human beings" },
	...
	{ "6.5.2", "Deliberate infliction of pain to fantasy characters (including animation)" },
	{ "6.5.2.1", "One scene of deliberate infliction of pain to fantasy characters (including animation)" },
	{ "6.5.2.2", "Occasional deliberate infliction of pain to fantasy characters (including animation)" },
	{ "6.5.2.3", "Frequent deliberate infliction of pain to fantasy characters (including animation)" },
	{ "6.5.3", "Deliberate killing of fantasy characters (including animation)" },
	{ "6.5.3.1", "One scene of deliberate killing of fantasy characters (including animation)" },
	{ "6.5.3.2", "Occasional deliberate killing of fantasy characters (including animation)" },
	{ "6.5.3.3", "Frequent deliberate killing of fantasy characters (including animation)" },
	{ "6.6", "LANGUAGE" },
	{ "6.6.1", "No language descriptors" },
	{ "6.6.10", "Occasional use of offensive language (racist, homophobic, sexist)" },
	{ "6.6.11", "Frequent use of offensive language (racist, homophobic, sexist)" },
	...
	{ "6.7.2", "Factual material that may cause distress, including verbal descriptions of traumatic events and the telling of sensitive human interest stories." },
