...
void CReceiverQt::EnumerateInputs(vector<string>& names, vector<string>& descriptions, string& defaultInput)
{
    CDRMReceiver::EnumerateInputs(names, descriptions, defaultInput);
}

void CReceiverQt::EnumerateOutputs(vector<string>& names, vector<string>& descriptions, string& defaultOutput)
{
...
void CReceiverQt::StopWriteWaveFile()
{
    WriteData.StopWriteWaveFile();
}
...
void CReceiverQt::SetFlipSpectrum(bool b)
{
    ReceiveData.SetFlippedSpectrum(b);
}
...
void CReceiverQt::SetConsiderInterferer(bool b)
{
    SetIntCons(b);
}

void CReceiverQt::MuteAudio(bool b)
{
    WriteData.MuteAudio(b);
}
...
void CReceiverQt::SetAMFilterBW(int n)
{
    AMDemodulation.SetFilterBW(n);
}

void CReceiverQt::SetAMAGCType(EAmAgcType e)
{
    AMDemodulation.SetAGCType(e);
}
...
void CReceiverQt::SetFrequency(int n)
{
    CDRMReceiver::SetFrequency(n);
}

void CReceiverQt::SetAMDemodAcq(_REAL r)
{
    CDRMReceiver::SetAMDemodAcq(r);
}

void CReceiverQt::EnableAMPLL(bool b)
{
    AMDemodulation.EnablePLL(b);
}
